...
public class Customer extends MainMenu {
    ...
    public void start() {
        ...
        do {
            // Main Menu
			System.out.println ("--------------------------");
            choice = showMenu("|| CUSTOMER'S MAIN MENU ||\n--------------------------", new String[]{"Add Order", "Edit Order", "Delete Order", "View Orders/Receipt", "Checkout", "Return to Main Menu"});
